                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    ...
                                    <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">S'inscrire</a>
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    ...
                                    <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">R&eacute;server</a>
                                    <a href="" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Imprimer invitation</a>
                                </div>
                            </div>
                        </div>
                    </div>
